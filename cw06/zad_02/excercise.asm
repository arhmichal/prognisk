...
; Dostępny jest plik funcja.c z funkcją main i plik binarny funkcja32  programu w wersji 32-bit. Chciano przekompilować ten program do wersji 64-bitowej. Niestety zaginął plik C  z definicją funkcji  
;   char f(char, char, char);

; Odtwórz ten plik używając gdb i analizując funkcję f. 
