...
; zadanie 03
;
; Napisz w asemblerze funkcję 
; void sortuj(int n, float * tab)
; sortującą daną tablicę tab o wymiarze n

; Zooptymalizuj ją tak aby działała jak najszybciej na komputerach w pracowniach wydziałowych w trybie 32-bitowym. 
